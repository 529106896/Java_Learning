	...
	public static void addVehicle() throws Exception 
	{
		...
		while(!inputString.equals("end"))
		{
			...
			if(inputs[0].equals("小汽车"))
			{
				...
				car newCar = (car) Class.forName("lab7_6.car").getConstructor(String[].class).newInstance((Object)inputs);
				carList.add(newCar);
				System.out.println("创建成功");
			}
			else if(inputs[0].equals("卡车"))
			{
				truck newTruck = (truck) Class.forName("lab7_6.truck").getConstructor(String[].class).newInstance((Object)inputs);
